...
#' viz_palette(uos_palettes$marine, "marine")
#' viz_palette(uos_palettes$marine, "marine first 4", num = 4)
#' viz_palette(uos_palettes$marine, "marine interpolated to 25", num = 25)
#'
#' @export
